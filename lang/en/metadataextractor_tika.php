...
$string['error:local:nooptionset'] = 'No option(s) set for Tika local application execution.';
...
$string['error:server:invalidoptions'] = 'Invalid Tika Server extractor options.';
